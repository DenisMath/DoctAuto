...
Дослідження групових автоматів  є технічно достатньо складною задачею. Представлення групових автоматів віповідними 2-адичними фунціями надає зручну техніку для роботи з ними. Оскільки на данний момент існує багато нерозв'язаних проблем, пов'язаних з групою скінченно-станових автоматних підстановок, то є природнім виділення в цьому класі функцій, що відповідають скінченно-становим автоматам. Метою даної роботи є опис класу скінченно-автоматних дифференційовних функцій кільця $Z_2$.  
\begin{theorem}\label{lin_rational_point}
Скінченно-станова  ізометрія кільця $Z_2$ є
...
\begin{proof}
 ...
 \end{proof}
Технічно зручним для дослідження скінченно-становості є наслідок теореми \ref{sec:-fundtheorem}
