...
\begin{theorem}
  Нехай a - скінченно-станова 0-повна сферично-транзитивна
  ізометрія. Скінченно-станові ізометрії $a$ та $b$ спряженні в $FAutT_2$ тоді, і лише тоді, коли 
існує скінченно-становий автоморфізм $\chi_0$ такий, що 
