...
У роботі будемо використовувати наступні означення:
...
будемо казати, що автоморфізм $\chi_0$ є 0-~розв'язком рівняння $a^{\chi_0}=b$, якщо $0*\chi_0=0$
\end{defi}

Ототожнимо автоморфізм $a$ дерева $T_2$ з функцією $f_a:Z_2\rightarrow Z_2$ наступним чином:
$$x*a = f_a(x)$$.
...
$x*a$ -  дію автоморфізма $a$ на кінець $x$ дерева $T_2$,
